...
//    	Log.i(TAG, "Query URL: " + full_url);
    ...
    public static HashMap<Long, Integer> parse_taxon_popularity_response(String query_argument) throws UnknownHostException {
        ...
        final HashMap<Long, Integer> popularity_hash = new HashMap<Long, Integer>(); 
...
//            throw new RuntimeException(e);
    ...
    public ArrayList<HashMap<String, String>> parse_photos_response() {
    	
        RootElement root = new RootElement( "xml" );
        Element result_item_container = root.getChild( "photos" );

        final ArrayList<HashMap<String, String>> result_hash = new ArrayList<HashMap<String, String>>(); 
        result_item_container.getChild("photo").setStartElementListener(new StartElementListener() {
			
			public void start(Attributes attributes) {
				HashMap<String, String> row_result = new HashMap<String, String>();
...
//            throw new RuntimeException(e);
    ...
    static public ArrayList<HashMap<String, String>> parse_photos_response_string(String xml_string) {
