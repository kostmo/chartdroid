...
//        Rectangle bounds = note.getBounds();
        RectF bounds = note.getBounds();
        if (bounds != null) {
//            parameters.add(new Parameter("note_x", String.valueOf(bounds.x)));
            parameters.add(new Parameter("note_x", String.valueOf(bounds.left)));
//            parameters.add(new Parameter("note_y", String.valueOf(bounds.y)));
            parameters.add(new Parameter("note_y", String.valueOf(bounds.top)));
