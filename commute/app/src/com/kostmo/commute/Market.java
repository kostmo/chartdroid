...
public class Market {
    ...
    public static final String WEBSITE_URL = "http://code.google.com/p/chartdroid/wiki/CommuteTimer";
    ...
    public static final String CHARTDROID_PACKAGE_NAME = "com.kostmo.commute";
