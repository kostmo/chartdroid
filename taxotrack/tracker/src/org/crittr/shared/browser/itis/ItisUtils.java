...
public class ItisUtils {
	...
	// FUNCTION TABLE:
	static String[] heirarchy_tags = {PARENT_NAME_TAG, PARENT_TSN_TAG, RANK_NAME_TAG, TAXON_NAME_TAG, TSN_TAG};
	static String[] common_name_tags = {COMMON_NAME_TAG, LANGUAGE_TAG, TSN_TAG};
	static String[] scientific_name_tags = {COMBINED_NAME_TAG, UNIT_1_TAG, UNIT_2_TAG, UNIT_3_TAG, UNIT_4_TAG, GENUS_TAG, SPECIES_TAG, SUBSPECIES_TAG, SUBSUBSPECIES_TAG, TSN_TAG};

	static String[] getGeographicDivisionsFromTSN_tags = {GEOGRAPHIC_VALUE_TAG, UPDATE_DATE_TAG};
	static String[] getTaxonomicRankNameFromTSN_tags = {KINGDOM_ID_TAG, KINGDOM_NAME_TAG, RANK_ID_TAG, RANK_NAME_TAG, TSN_TAG};

	static String[] kingdom_names_tags = {KINGDOM_ID_TAG, KINGDOM_NAME_TAG};
	static String[] rank_names_tags = {KINGDOM_ID_TAG, KINGDOM_NAME_TAG, RANK_ID_TAG, RANK_NAME_TAG};
	static String[] itis_terms_tags = {COMMON_NAMES_TAG, NAME_USAGE_TAG, SCIENTIFIC_NAME_TAG, TSN_TAG};
